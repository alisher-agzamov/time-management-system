  ...
  <div>
    ...
    <div class="w-50 m-auto text-left">
      ...
      <div class="form-group">
        <label for="task-title">{{ $t("edit_task.form_field_title") }}</label>
        <input v-model="task.title" type="text" class="form-control" id="task-title" :placeholder="$t('edit_task.form_field_title_placeholder')">
      </div>

      <div class="form-group">
        <label for="task-description">{{ $t("edit_task.form_field_description") }}</label>
      ...
      <div class="form-group">
        <label for="task-date">{{ $t("edit_task.form_field_date") }}</label>
      ...
      <div class="form-group">
        <div>
          <label for="register-preferred-working-hour-per-day">{{ $t("edit_task.form_field_duration") }}</label>
        </div>

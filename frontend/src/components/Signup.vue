<template>
  <div>
    ...
    <div class="w-50 m-auto text-left">
      ...
      <div class="form-group">
        <label for="register-password">{{ $t("signup.form_field_password") }}</label>
      ...
      <div class="form-group">
        <label for="register-password-confirmation">{{ $t("signup.form_field_password_confirmation") }}</label>
      ...
      <div class="form-group">
        <label for="register-preferred-working-hour-per-day">{{ $t("signup.form_field_preferred_working_hours") }}</label> <br />
